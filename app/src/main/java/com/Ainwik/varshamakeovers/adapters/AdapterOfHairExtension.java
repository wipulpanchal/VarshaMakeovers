...
public class AdapterOfHairExtension extends RecyclerView.Adapter<AdapterOfHairExtension.MyViewHolder>
{
    ...
    public AdapterOfHairExtension(Context context, ArrayList<RecordsOfHairTreatment> arrayList)
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        View view=LayoutInflater.from(context).inflate(R.layout.custom_layout_of_hair_extension,parent,false);
