...
public class AdapterOfHairTreatment extends RecyclerView.Adapter<AdapterOfHairTreatment.MyViewHolder>
{
    ...
    public AdapterOfHairTreatment(Context context, ArrayList<RecordsOfHairTreatment> arrayList)
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        View view=LayoutInflater.from(context).inflate(R.layout.custom_layout_of_hairtreatment,parent,false);
